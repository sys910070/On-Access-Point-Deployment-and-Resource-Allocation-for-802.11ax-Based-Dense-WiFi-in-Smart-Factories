...
class DEVICE:
    ...
    # device movement apply the mobility model
    def move(self):
        if self.type == 2:
            if factory_environment == 'no_obstacle':
                # region 5
                if self.x != 0 and self.x != 180 and self.y != 0 and self.y != 200:
                ...
                # region 1
                    ...
                    if num == 1:
                        ...
                        self.y += 1
                # region 2
                elif self.x == 0 and self.y != 0 and self.y != 200:
                    num = random.randint(1, 4)
                    if num == 1 or num == 2:
                        self.x += 1
                    elif num == 3:
                ...
                # region 3
                    ...
                    if num == 1:
                        ...
                        self.y -= 1
                # region 4
                elif self.y == 0 and self.x != 0 and self.x != 180:
                    num = random.randint(1, 4)
                    if num == 1 or num == 2:
                        self.y += 1
                    elif num == 3:
                        ...
                        self.x -= 1
                # region 6
                elif self.y == 200 and self.x != 0 and self.x != 180:
                    num = random.randint(1, 4)
                    if num == 1 or num == 2:
                        self.y -= 1
                    elif num == 3:
                ...
                # region 7
                    ...
                    if num == 1:
                        ...
                        y += 1
                # region 8
                elif self.x == 180 and self.y != 0 and self.y != 200:
                    num = random.randint(1, 4)
                    if num == 1 or num == 2:
                        self.x -= 1
                    elif num == 3:
                        ...
                        self.y -= 1
                # region 9
                elif self.x == 180 and self.y == 200:
                    num = random.randint(1, 2)
                    if num == 1:
                        self.x -= 1
                    else:
